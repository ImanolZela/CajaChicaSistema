...
public class TipoComprobanteController {
	...
	public ArrayList<TipoComprobanteModel> listaTipoComprobante() {
		Statement st3 = null;
		ResultSet rs3 = null;
		TipoComprobanteModel tipoComprobanteModel;
		...
		try {
			...
			while (rs3.next()) {
				...
				tipoComprobanteModel = new TipoComprobanteModel(tipo_comprobante_id, nombre_tipo_comprobante);
