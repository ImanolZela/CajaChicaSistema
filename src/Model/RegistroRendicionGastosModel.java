...
public class RegistroRendicionGastosModel {
	...
	public RegistroRendicionGastosModel() {

	}

	public RegistroRendicionGastosModel(int caja_id, int categoria_id, int tipo_comprobante_id, String num_comprobante,
