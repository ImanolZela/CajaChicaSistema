...
public class RegistroCajaChicaModel {
	...
	public RegistroCajaChicaModel() {

	}

	public RegistroCajaChicaModel(int usuario_id, String nombre_proyecto, String descripcion, double monto_asignado,
	...
	public RegistroCajaChicaModel(int caja_id, int usuario_id, String nombre_proyecto, double monto_asignado) {
		this.usuario_id = usuario_id;
		this.nombre_proyecto = nombre_proyecto;
		this.monto_asignado = monto_asignado;
	...
	public String toString() {
		return nombre_proyecto; // Este es el valor que se mostrará en el JComboBox
	}
